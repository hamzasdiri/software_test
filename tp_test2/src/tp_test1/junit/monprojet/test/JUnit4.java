...
public class JUnit4 {
    ...
    public void setUp() {
        ...
        nbPassages++;
        System.out.println(nbPassages + "ème passage avant exécution d'une méthode de test");
    }
    
    @After
    public void tearDown() {
        System.out.println(nbPassages + "ème passage APRES exécution d'une méthode de test");
    }
